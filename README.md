...
**已实现核心闭环**：
- [x] **全栈架构**：Next.js + Supabase + Docker 完整跑通。
- [x] **AI 驱动**：支持自然语言生成应用，集成 OpenRouter 多模型。
- [x] **实时预览**：Sandpack 预览 + 无限画布拖拽体验。
- [x] **安全沙盒**：基于 Docker 的 Web 终端，支持命令执行。

**功能演示**：

| 界面概览 | 侧边栏与历史 |
|:---:|:---:|
| ![界面演示1](./完成情况截图/界面演示1.png) | ![界面演示2](./完成情况截图/界面演示2.png) |

| AI 思考过程 | 分享与预览 |
|:---:|:---:|
| ![界面演示3](./完成情况截图/界面演示3.png) | ![界面演示4](./完成情况截图/界面演示4.png) |

> [!NOTE]
> 自定义设置提示词/mcp等功能(./完成情况截图/提示词注入.png)
